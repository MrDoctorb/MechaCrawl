...
public class DungeonGenerator : MonoBehaviour
{
    ...
    void MakeRoom(Vector2Int startPos, int width, int height)
    {
        for (int i = 0; i < width; ++i)
        {
            ...
            {
                dungeonTiles[startPos.x + i, startPos.y + j] = new DungeonTile(startPos + new Vector2Int(i, j), currentid, DungeonTileType.Room);
    ...
    void Connect()
    {
        ...
        foreach (Connector connector in connectors)
        {
            if (!IDsInUse(connector.id1, connector.id2))
            {
                ...
                dungeonTiles[connector.pos.x, connector.pos.y] = new DungeonTile(connector.pos, connector.id1, DungeonTileType.Connector);
...
public class DungeonTile
{
    ...
    public DungeonTile(Vector2Int pos, int id, DungeonTileType type)
    {
        this.pos = pos;
        this.id = id;
        this.type = type;
